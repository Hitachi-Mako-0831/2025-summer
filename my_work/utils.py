...
def save_rewrite(rewrite_data, filename='News_result/rewrite_data.json'):
...
def save_features(feature_vectors, filename='News_result/feature_vectors.json'):
    try:
        with open(filename, 'w', encoding='utf-8') as f:
